    ...
    editarFila = () => {
        ...
        /*
            swal({
                ...
                //text: estadoAlumno.state.pagos[0].apeNom.toString(),
                ...
                <td className="td">
                    ...
                    <div id="modal1" class="modal">
                        ...
                        <datalist id="browsers">
                            ...
                            <option>Concepto 5</option>
                        </datalist>


                        <p>Dependencia:</p> <h5> Valor Dependencia </h5>
                        <p>Fecha:</p> <h5> dia/mes/año </h5>
                        <p>Moneda:</p>
